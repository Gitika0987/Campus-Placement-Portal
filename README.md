...
See AWS_DEPLOYMENT.md for full step-by-step instructions.
...
ARCHITECTURE.md	System architecture, components, AWS cloud diagram
AWS_DEPLOYMENT.md	Step-by-step EC2 + Docker + S3 deployment
PERFORMANCE_REPORT.md	Load test results, fault tolerance, analysis
